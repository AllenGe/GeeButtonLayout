...
//  GYJDemo
//
//  Created by gyj on 2022/04/20.
//  Copyright © 2022年 gyj. All rights reserved.
//

#import "LLGYJCarouselView.h"
...
@interface LLGYJCarouselView() <UIScrollViewDelegate>
...
@implementation LLGYJCarouselView
...
- (void)startTimer {
    ...
    if (_isAutoScroll && _imageCount>1) {
        __weak LLGYJCarouselView *weakSelf = self;
